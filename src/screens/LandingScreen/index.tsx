...
// Constants for background styles
...
const LandingScreen: React.FC<LandingScreenProps> = ({ navigation }) => {
    const [coords, setCoords] = useState({
        latitude: -26.248387319508478,
        longitude: 27.853800034649797,
    });
    ...
    //     // Use the backgroundStyles object to set the weather condition
    //     setWeatherCondition(backgroundStyles[condition] || defaultBg);
    //   };
                    ...
                    <View style={styles.weatherContainer}>
                        ...
                        <View style={styles.weatherTemp}>
                            <Text style={styles.tempP}>
                                {(selector.weather.currentWeather.temp).toFixed(1)}°
                            </Text>
                        ...
                        >
                            <View>
                                <Text style={[styles.p, { fontWeight: "bold" }]}>
                                    {(selector.weather.currentWeather.min).toFixed(1)}°
                                </Text>
                            ...
                            <View>
                                <Text style={[styles.p, { fontWeight: "bold" }]}>
                                    {(selector.weather.currentWeather.max).toFixed(1)}°
                                </Text>
                            ...
                            {Object.values(selector.weather.next5Days).map((weather: any) => (
                                <View style={styles.listItemsContainer} key={weather.date}>
                                    ...
                                    <Text style={[styles.p, { flex: 1, textAlign: "right" }]}>
                                        {(weather.averageTemperature).toFixed(1)}°
                                    </Text>
                                </View>
                            ))}
                        </ScrollView>
...
// import { addCityWeatherToFavourites, fetchWeatherForecast, setWeatherData } from '../../features/weather/weatherSlice'; // Replace with the actual path
// import { StackNavigationProp } from "@react-navigation/stack";
// import { RootStack } from "../../types";
// import Toast from "react-native-toast-message";
...
//             return rainyBg.img;
//         } else {
//             return defaultBg.img;
//         }
//     };
//     const getWeatherStylesSource = () => {
//         const weatherMain = selector.weather.currentWeather.main;
//         if (weatherMain === 'Clouds') {
//             return cloudyBg.styles;
//         } else if (weatherMain === 'Clear') {
//             return sunnyBg.styles;
//         } else if (weatherMain === 'Rain') {
//             return rainyBg.styles;
//         }
//     };
//     const handleGoToFavourites = () => {
//         navigation.navigate('Favourites');
...
//                 <View style={styles.weatherContainer}>
//                     <Image source={getWeatherImageSource()} resizeMode="cover" style={{ height: '100%', width: '100%', }} />
//                     <View style={styles.weatherTemp}>
